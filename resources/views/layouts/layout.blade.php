...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - @yield('meta-title', __("messages.meta.title")) </title>
    <meta name="description" content="@yield('meta-description', __("messages.meta.description"))">
    <!-- Scripts -->
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-contact">
                    ...
                    <p> Os. Stefana Batorego 57 <br>
                        ...
                        <strong><img src="{{asset('images/icons8-phone-off-the-hook-16.png')}}" width="16" height="16" alt="phone-icon" /></strong>  +48 61 824 9541<br>
